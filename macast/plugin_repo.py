...
# answers. raw.githubusercontent.com is canonical but is routinely unreachable
# from mainland China; jsDelivr mirrors the same file over a CDN that usually
# still resolves there. Both send CORS headers, which matters because this
# fetch runs in the browser, not in Python.
INDEX_URLS = (
