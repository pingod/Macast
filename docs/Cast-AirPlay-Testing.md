...
# 查看 TXT 记录（确认端口）
dns-sd -L "Macast(MyHost-1754.local)" _googlecast._tcp
dns-sd -L "Macast(MyHost-1754.local)" _airplay._tcp
...
```shell
~/.workbuddy/binaries/python/envs/macast/bin/python scripts/verify_cast_airplay.py
```
