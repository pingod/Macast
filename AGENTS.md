...
# 2) 回归验证（2026-09-25 本机实测 1634/1640 通过（红的 6 条见下面那段）；**总数随环境伸缩**：场上有一个在跑的 Macast（占着
