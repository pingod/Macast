...
# 2) 回归验证（2026-09-24 本机实测 1463/1469 通过（红的 6 条见下面那段）；**总数随环境伸缩**：场上有一个在跑的 Macast（占着
...
| `verify_cast_airplay.py` | **主验证套件**（2026-09-24 本机实测 1463/1469 通过，红的 6 条是 Part 34 —— 见 §4.12 末条；它随数据规模伸缩：索引清空后，按条目循环的那些用例
